...
#define STRING_CONFIG_H_AUTHOR "Nut E3V2" // Who made the changes. // Nut E3V2
...
#define CUSTOM_MACHINE_NAME "Ender3V2-422-BLTUBL-HomeOffs-IS-LA-MPC-Speaker-SkewXYZ-Maxtemp"
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 200, 10000 }  // Nut E3V2
...
#define Z_CLEARANCE_MULTI_PROBE     2 // (mm) Z Clearance between multiple probes  // Nut E3V2
...
#define HOMING_FEEDRATE_MM_M { (100*60), (100*60), (16*60) }  // Nut E3V2 Homing speed-up
