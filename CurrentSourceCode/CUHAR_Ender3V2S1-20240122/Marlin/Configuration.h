...
#define STRING_CONFIG_H_AUTHOR "Phuwanut Pataratawinun" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CUHAR_E3V2_B427"
 ...
 */
#define X_DRIVER_TYPE  TMC2208  // Ender Configs
#define Y_DRIVER_TYPE  TMC2208  // Ender Configs
#define Z_DRIVER_TYPE  TMC2208  // Ender Configs
...
#define E0_DRIVER_TYPE TMC2208  // Ender Configs
 ...
 */
  ...
  #define MPC_HEATER_POWER { 31.0f }                  // (W) Heat cartridge powers.

  #define MPC_INCLUDE_FAN                             // Model the fan speed?

  // Measured physical constants from M306
  #define MPC_BLOCK_HEAT_CAPACITY { 5.60f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.2223f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0800f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1080f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define PIDTEMPBED  // Ender Configs
  ...
  #define DEFAULT_bedKp 196.75
  #define DEFAULT_bedKi  38.43
  #define DEFAULT_bedKd 671.57
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 413.0 }  // Ender Configs
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 600, 600, 25, 180 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 200, 5000 }  // Ender Configs
...
#define DEFAULT_RETRACT_ACCELERATION  1500    // E acceleration for retracts  // Ender Configs
#define DEFAULT_TRAVEL_ACCELERATION   2000    // X, Y, Z acceleration for travel (non printing) moves  // Ender Configs
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 44.1, 26.4, 0 }  // MRiscoC BLTouch offset for support: https://www.thingiverse.com/thing:4605354 (z-offset = -1.80 mm)
...
#define XY_PROBE_FEEDRATE (300*60)  // MRiscoC increase travel speed between probes
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE    10 // (mm) Z Clearance for Deploy/Stow  // MRiscoC Increase speed
#define Z_CLEARANCE_BETWEEN_PROBES  4 // (mm) Z Clearance between probe points  // MRiscoC Increase probe compatibility
#define Z_CLEARANCE_MULTI_PROBE     3 // (mm) Z Clearance between multiple probes  // MRiscoC Increase speed
...
#define Z_MAX_POS 260  // Ender Configs
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 45              // Set Mesh bounds as an inset region of the bed  // MRiscoC Center mesh
...
#define HOMING_FEEDRATE_MM_M { (100*60), (100*60), (16*60) }  // MRiscoC Homing speed-up
