...
#define STRING_CONFIG_H_AUTHOR "Phuwanut Pataratawinun" // Who made the changes. // Nut E3V2
...
#define CUSTOM_MACHINE_NAME "Nut E3V2 Y Inv"
 ...
 */
#define X_DRIVER_TYPE  TMC2208  // Nut HW Mod
#define Y_DRIVER_TYPE  TMC2208  // Nut HW Mod
#define Z_DRIVER_TYPE  TMC2208  // Nut HW Mod
...
#define E0_DRIVER_TYPE TMC2208  // Nut HW Mod
...
#define HEATER_0_MAXTEMP 300 // Nut E3V2 CHC Pro Hotend
 ...
 */
  ...
  #define MPC_HEATER_POWER { 40.0f }                  // (W) Heat cartridge powers. // Nut E3V2

  #define MPC_INCLUDE_FAN                             // Model the fan speed?

  // Measured physical constants from M306 // Nut E3V2
  #define MPC_BLOCK_HEAT_CAPACITY { 6.79 }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.2652 }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0770 }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.0899 }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define PIDTEMPBED  // Ender Configs
  ...
  #define DEFAULT_bedKp 214.51 // Nut E3V2
  #define DEFAULT_bedKi  40.02 // Nut E3V2
  #define DEFAULT_bedKd 766.52 // Nut E3V2
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 410 }  // Ender Configs  // Nut E3V2
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 25, 200 }  // Nut E3V2

#define DEFAULT_FEEDRATE_MM_M (100*60)
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 200, 10000 }  // Nut E3V2
 ...
 */
#define DEFAULT_ACCELERATION          3000    // X, Y, Z and E acceleration for printing moves  // Nut E3V2
...
//#define CLASSIC_JERK  // Ender Configs
  ...
  #define DEFAULT_XJERK 4.0  // Ender Configs
  #define DEFAULT_YJERK 4.0  // Ender Configs
  #define DEFAULT_ZJERK  0.1  // Ender Configs
...
#define DEFAULT_EJERK    3.0  // May be used by Linear Advance  // Ender Configs
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 3.15, -41.33, 0 }  // Nut E3V2 DIY Mount
...
#define PROBING_MARGIN 10  // Nut E3V2 Mriscoc locked to min. 10

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (400*60)  // Nut E3V2
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE    4 // (mm) Z Clearance for Deploy/Stow  // Nut E3V2
#define Z_CLEARANCE_BETWEEN_PROBES  2 // (mm) Z Clearance between probe points  // Nut E3V2
#define Z_CLEARANCE_MULTI_PROBE     1 // (mm) Z Clearance between multiple probes  // Nut E3V2
#define Z_PROBE_ERROR_TOLERANCE     2 // (mm) Tolerance for early trigger (<= -probe.offset.z + ZPET) // Nut E3V2
#define Z_AFTER_PROBING           3 // (mm) Z position after probing is done 

#define Z_PROBE_LOW_POINT          -2 // (mm) Farthest distance below the trigger-point to go before stopping  // Nut E3V2
...
//#define PREHEAT_BEFORE_PROBING
  ...
  #define PROBING_BED_TEMP     60   // Nut E3V2 set auto mesh menu temp
#endif
...
#define X_BED_SIZE 235  // Nut E3V2 Max usable bed size
#define Y_BED_SIZE 235  // Nut E3V2 Max usable bed size

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0   // Nut E3V2 Endstop position
#define Y_MIN_POS 0   // Nut E3V2 Endstop position
#define Z_MIN_POS 0
#define X_MAX_POS X_MIN_POS + 250  // Nut E3V2
#define Y_MAX_POS Y_MIN_POS + 250  // Nut E3V2
#define Z_MAX_POS 255  // Nut E3V2
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 52              // Set Mesh bounds as an inset region of the bed  // Nut E3V2 Center mesh
  #define GRID_MAX_POINTS_X 6      // Don't use more than 15 points per axis, implementation limited.  // MRiscoC Customizable by menu
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
...
#define LCD_BED_TRAMMING  // ProUI has a bed tramming menu
   ...
   */
  #define BED_TRAMMING_LEVELING_ORDER { RF, RB, LB, LF }
#endif
...
#define HOMING_FEEDRATE_MM_M { (80*60), (80*60), (20*60) }  // Nut E3V2 Homing speed-up
...
#define NOZZLE_PARK_FEATURE  // MRiscoC Enabled
  ...
  #define NOZZLE_PARK_POINT { (245), (Y_MAX_POS), 20 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { { 235, 0, (Z_MIN_POS + 2) } } // Nut E3V2 brush (future)
  #define NOZZLE_CLEAN_END_POINT   { { 245, 8, (Z_MIN_POS + 2) } } // Nut E3V2 brush (future)
