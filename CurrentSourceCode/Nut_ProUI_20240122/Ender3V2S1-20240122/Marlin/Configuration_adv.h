 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 30        // (seconds) // Nut E3V2
 ...
 */
#define PREHEAT_TIME_HOTEND_MS 5000 // Nut E3V2 increase safety
...
#define HOMING_BUMP_DIVISOR { 10, 10, 10 }    // Nut E3V2 Slow down Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_ZETA_Y  0.f       // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
 ...
 */
   ...
   */
  #if HAS_STEALTHCHOP
    // #define STEALTHCHOP_XY // Nut HW Mod
    // #define STEALTHCHOP_Z // Nut HW Mod
    ...
    // #define STEALTHCHOP_E // Nut HW Mod
  #endif
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below)  // MRiscoC Correct value for UART mode drivers // Nut confirmed
...
#define MECHANICAL_GANTRY_CALIBRATION
  ...
  #define GANTRY_CALIBRATION_FEEDRATE        4*60     // Feedrate for correction move
  #define GANTRY_CALIBRATION_TO_MIN                   // Enable to calibrate Z in the MIN direction

  #define GANTRY_CALIBRATION_SAFE_POSITION { X_MAX_POS, Y_MIN_POS } // Safe position for nozzle
  #define GANTRY_CALIBRATION_XY_PARK_FEEDRATE 300*60  // XY Park Feedrate - MM/S
