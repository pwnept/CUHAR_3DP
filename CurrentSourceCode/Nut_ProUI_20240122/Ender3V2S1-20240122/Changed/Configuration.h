...
#define STRING_CONFIG_H_AUTHOR "Nut" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Nut Ender3V2-422-BLTUBL"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 415 }  // Nut Ender Configs
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 25, 60 }  // Nut Ender Configs
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 45.5, 13, 0 }  // Ender 3 V2 BMG Mount https://www.thingiverse.com/thing:4441537
